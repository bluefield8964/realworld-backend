...
public enum ErrorCode {
    ...
    JSON_ERROR(7000,"JSON ERROR" ),
    EVENT_PROCESSING(7000,"EVENT PROCESSING" ),
    ORDER_FAILED(7000,"ORDER_FAILED" ),
    LOCK_CANT_REQUIRE(7000,"LOCK CANT REQUIRE" ),
    RETRY_EXHAUSTED(7000,"RETRY_EXHAUSTED" ),
    IDEMPOTENCYLOCK_CANT_REQUIRE(7000,"IDEMPOTENCYLOCK_CANT_REQUIRE" ),
     LOCK_INTERRUPTED(7000,"LOCK_INTERRUPTED" );
